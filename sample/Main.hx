...
function main() {
	...
	final vertexShader = device.createShaderModuleFromFile("res/triangle.vert.spv");
	final fragmentShader = device.createShaderModuleFromFile("res/triangle.frag.spv");
